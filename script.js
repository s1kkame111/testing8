const data = [
    {
        ...
        title:'КРИЗИ ТА',
        title2:'РЕФОРМИ',
        let description = "У Третій республіці виникали політичні кризи, серед яких найвідомішою була Справа Дрейфуса. Вона розділила суспільство на прихильників і противників справедливості. Водночас до влади приходили радикали, які проводили реформи, зокрема відокремлення церкви від держави та розвиток освіти.";
console.log(description);
    ...
    },
    {
        ...
        title:'ПРЕКРАСНА',
        title2:'ЕПОХА',
        let description = "«Belle Époque» — це період розквіту культури, мистецтва та науки у Франції. У цей час активно розвивалася 
...
console.log(description);
    ...
    },
    {
        ...
        title:'ВИСТАВКИ ТА',
        title2:'НАУКА',
        let description = "У Франції проводилися Всесвітні виставки, які демонстрували технічні досягнення різних країн. Найвідомішою 
...
console.log(description);
    ...
    },
    {
        ...
        title:'ПОЛІТИЧНІ',
        title2:'ЗМІНИ',
        let description = "Після поразки у Франко-прусська війна у Франції відбулися значні зміни. Було повалено монархію і створено 
...
console.log(description);
    ...
    },
    {
        ...
        title:'ОСНОВНІ',
        title2:'ТЕМИ',
        let description = "У цьому проєкті розглядається розвиток Франції в період так званої «Прекрасної епохи». Це був час швидкого 
...
console.log(description);
    ...
    },
    {
        ...
        title:'МИСТЕЦТВО І',
        title2:'СТИЛЬ',
        let description = "У період «Прекрасної епохи» у Франції активно розвивалися нові напрямки мистецтва, зокрема імпресіонізм і постімпресіонізм. Художники намагалися передати не точні деталі, а свої враження від світу — світло, рух, настрій. У картинах часто зображували природу, міське життя та повсякденні сцени
